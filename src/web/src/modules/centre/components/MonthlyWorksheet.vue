    ...
    <div v-for="section of month.sections" style="clear: both">
      ...
      <table style="width: 100%" cellpadding="0" cellspacing="0" border="0px">
        <tr class="text-left">
          ...
          <td class="pl-4" style="width: 120px">Per child</td>
          <td class="pl-4" style="width: 120px">Est</td>
          <td class="pl-4">Est Total</td>
          <td class="pl-4" style="width: 120px">Act</td>
          <td class="pl-4">Act Total</td>
        </tr>
        <tr class="monospace" v-for="line of section.lines">
          ...
          <td>
            <v-text-field
              ...
              density="compact"
              hide-details
              @change="changeLine(line)"></v-text-field>
          </td>
          <td>
            <v-text-field
