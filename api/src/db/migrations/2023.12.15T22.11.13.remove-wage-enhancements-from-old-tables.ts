...
export async function up({ context: queryInterface }: Migration) {
  const WAGE_ENHANCEMENT_SECTION_NAME = "Wage Enhancement"

  // Update funding_submission_line_jsons to remove lines with Wage Enhancement section
  ...
  await queryInterface.sequelize.query(
    ...
    {
      replacements: {
        sectionName: WAGE_ENHANCEMENT_SECTION_NAME,
      },
    }
  )

  // Delete the Wage Enhancement funding submission lines
  await queryInterface.sequelize.query(
    sql`
